...
/// Effects palette view controller for managing video and audio effects
@MainActor
final class EffectsPaletteViewController: NSViewController {
    // MARK: - Properties
    ...
    private func setupUI() {
        ...
        contentView.addSubview(videoEffectsScrollView)
        ...
        contentView.addSubview(addVideoEffectButton)
        ...
        contentView.addSubview(audioEffectsScrollView)
        ...
        contentView.addSubview(addAudioEffectButton)
        ...
        contentView.addSubview(savePresetButton)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            presetPopupButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            presetPopupButton.topAnchor.constraint(equalTo: presetLabel.bottomAnchor, constant: 8),
            presetPopupButton.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -16),
            presetPopupButton.heightAnchor.constraint(equalToConstant: 30),

            // Video effects section
            videoLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            videoLabel.topAnchor.constraint(equalTo: presetPopupButton.bottomAnchor, constant: 20),

            videoEffectsScrollView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            videoEffectsScrollView.topAnchor.constraint(equalTo: videoLabel.bottomAnchor, constant: 8),
            videoEffectsScrollView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -16),
            videoEffectsScrollView.heightAnchor.constraint(equalToConstant: 150),

            addVideoEffectButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            addVideoEffectButton.topAnchor.constraint(equalTo: videoEffectsScrollView.bottomAnchor, constant: 8),

            // Audio effects section
            audioLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            audioLabel.topAnchor.constraint(equalTo: addVideoEffectButton.bottomAnchor, constant: 20),

            audioEffectsScrollView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            audioEffectsScrollView.topAnchor.constraint(equalTo: audioLabel.bottomAnchor, constant: 8),
            audioEffectsScrollView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -16),
            audioEffectsScrollView.heightAnchor.constraint(equalToConstant: 150),

            addAudioEffectButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            addAudioEffectButton.topAnchor.constraint(equalTo: audioEffectsScrollView.bottomAnchor, constant: 8),

            // Preset management buttons
            savePresetButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            ...
            // Bottom padding
            contentView.bottomAnchor.constraint(equalTo: resetButton.bottomAnchor, constant: 16)
        ])
    }
